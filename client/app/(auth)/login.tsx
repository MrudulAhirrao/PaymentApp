    ...
    return (
        <View style={[styles.inputContainer, isFocused && styles.focusedInput]}>
            ...
            <View style={styles.fieldWrapper}>
                ...
                <TextInput style={styles.input} onFocus={handleFocus} onBlur={handleBlur} secureTextEntry={!isPasswordVisible} value={value} onChangeText={onChangeText} cursorColor={Colors.primary} autoCapitalize="none" keyboardType="email-address" />
            </View>
            {isPassword && (
    ...
    return (
        <SafeAreaView style={styles.container}>
            <Animated.View style={styles.header} entering={FadeInDown.duration(1000).springify()}>
                <View style={styles.logoContainer}><Ionicons name="wallet" size={50} color="#fff" /></View>
                <Text style={styles.title}>Welcome Back!</Text>
                <Text style={styles.subtitle}>Sign in to your FinDash account</Text>
            </Animated.View>
            ...
            <Animated.View style={styles.footer} entering={FadeInUp.delay(800).duration(1000).springify()}>
                <Text style={styles.footerText}>
                    Don’t have an account?{' '}
                    <Link href="/(auth)/register" asChild><Pressable><Text style={styles.link}>Sign Up</Text></Pressable></Link>
                </Text>
            </Animated.View>
        </SafeAreaView>
    );
